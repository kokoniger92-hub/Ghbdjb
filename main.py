...
def main():
    ...
    if not BOT_TOKEN:
        ...
        logger.error("Установите переменную окружения BOT_TOKEN в настройках Render")
        sys.exit(1)
    
    logger.info(f"Bot token loaded: {BOT_TOKEN[:6]}...{BOT_TOKEN[-4:]}")
    
    # Создаем event loop правильно для Render
